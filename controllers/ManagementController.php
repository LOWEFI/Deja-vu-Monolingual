...
class ManagementController extends BaseController
{
    ...
    private function handle_management_update()
    {
        ...
        if (isset($_POST['add_category'])) {
            ...
            if (is_null($category_name) || is_null($category_priority)) {
        ...
        if (isset($_POST['update_categories'])) {
            ...
            if (isset($_POST['categories']) && is_array($_POST['categories'])) {
                ...
                foreach ($_POST['categories'] as $category) {
                    ...
                    if (is_null($category_id) || is_null($category_name) || is_null($category_priority)) {
                        $errors[] = Language::get('category_information');
                    }
                    ...
                    if (empty($errors)) {
                        ...
                        if ($this->management_model->update_category($category_id, $category_name, $category_priority)) {
